...
<body id="page" class="page">
	...
	<div class="center error-<?php echo strtolower($error); ?>">
		<div id="gnomo">
			<img <source src="http://guildnews.org/templates/yoo_drive/styles/guildnews/images/icono-pandaria.png">
		</div>
		<h1 class="error">
	...
	<div id="gnomo2">
		<img <source src="http://guildnews.org/templates/yoo_drive/styles/guildnews/images/gnome-warrior.png">
	</div>
