...
<body id="page" class="page <?php echo $this['config']->get('body_classes'); ?>" data-config='<?php echo $this['config']->get('body_config','{}'); ?>'>
	...
	{
	if(divSelected != null) divSelected.className = '.wrapper';
	divSelected = x;
	x.className = '.wrapperleft';
	}
	</script>
	...
	<div class="wrapper grid-block">
		...
		<div id="block-side" class="grid-box" onclick="SelectOrUnSelect(t1)">
			<div id="side-container">

				<?php  if ($this['modules']->count('logo + search + menu')) : ?>
				<header id="header">
				...
				<aside id="sidebar-a" class="grid-block"><?php echo $this['modules']->render('sidebar-a', array('layout'=>'stack')); ?></aside>
				<?php endif; ?>
